...
GO_MODULES="services/api-gateway services/backend services/operator shared/types shared/middleware shared/server shared/logger shared/resilience shared/tracing shared/health shared/metrics shared/errors"
